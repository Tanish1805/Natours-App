...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaXRzLW1lMTgiLCJhIjoiY2x3OWw5NHg4MDFuMDJpcGE3YXhldmEzbyJ9.54mhLHVOImvUmaCsMEpoJQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/its-me18/clw9n15bz005z01qrhgz22t9k',
    // style URL
    scrollZoom: false
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "46943" + '/');
